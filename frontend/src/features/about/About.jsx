...
import { FiArrowRight, FiTerminal, FiLayers, FiActivity, FiGlobe } from "react-icons/fi";
...
const Pillar = ({ title, subtitle, icon: Icon, delay }) => (
    <motion.div
        className="group relative p-1 border-l border-white/10 hover:border-white transition-colors"
    >
        <div className="pl-8">
            <Icon className="text-white mb-6 opacity-30 group-hover:opacity-100 transition-opacity" size={28} />
            <h3 className="text-2xl font-bold mb-2 tracking-tighter uppercase" style={{ fontFamily: 'Orbitron, sans-serif' }}>{title}</h3>
...
const About = () => {
    ...
    return (
        <div ref={containerRef} className="bg-[#000000] text-white selection:bg-white selection:text-black">

            {/* ── 1. THE KINETIC HEADER ── */}
            <section className="relative h-screen flex flex-col justify-center items-center px-6 overflow-hidden">
                <motion.div style={{ x: xLeft }} className="absolute top-20 left-0 whitespace-nowrap opacity-[0.03] select-none pointer-events-none">
                    <span className="text-[15vw] font-black uppercase tracking-tighter">Architects of Code — Architects of Code —</span>
                </motion.div>
                ...
                <div className="z-10 text-center">
                    ...
                    <h1 className="text-[clamp(3rem,10vw,8rem)] font-black leading-[0.85] uppercase italic" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                        Kill the <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20">Ordinary.</span>
                    </h1>
                </div>

                <motion.div style={{ x: xRight }} className="absolute bottom-20 right-0 whitespace-nowrap opacity-[0.03] select-none pointer-events-none">
                    <span className="text-[15vw] font-black uppercase tracking-tighter text-white">VTRC TECHNOLOGIES — VTRC TECHNOLOGIES —</span>
                </motion.div>
            </section>
            ...
            <section className="py-40 px-6">
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    <div className="relative group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-white/20 to-white/5 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                        ...
                        <div className="absolute -bottom-6 -right-6 bg-white text-black p-6 rounded-xl hidden md:block">
                            <p className="text-[10px] font-black uppercase tracking-widest leading-none">Status: Operational</p>
                            <p className="text-2xl font-black mt-2">NYC / 40.7128° N</p>
                        </div>
                    </div>

                    <div>
                        <h2 className="text-4xl md:text-6xl font-bold uppercase mb-8 leading-none" style={{ fontFamily: 'Orbitron, sans-serif' }}>
                            The Anti-Agency <br /><span className="text-white/40">Philosophy.</span>
                        </h2>
                        ...
                        <div className="mt-12 flex items-center gap-6 p-6 border border-white/05 rounded-2xl bg-white/02 backdrop-blur-sm">
                            <img src={lionImg} alt="Founder" className="w-16 h-16 rounded-full object-cover border border-white/20" />
                            <div>
                                <h4 className="text-white font-bold uppercase tracking-widest text-sm">VTRC Founders</h4>
                                <p className="text-white/40 text-xs italic">"We build the tools we wish we had."</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-40 px-6 relative overflow-hidden bg-white text-black">
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    >
                        <span className="relative z-10 font-bold uppercase tracking-widest">Secure Your Slot</span>
                        <FiArrowRight className="relative z-10 group-hover:translate-x-2 transition-transform" size={24} />
                        <motion.div
