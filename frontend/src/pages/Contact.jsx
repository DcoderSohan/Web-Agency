          ...
          <section className="md:col-span-8 border-2 border-black p-6 md:p-8 bg-white">
            <form className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pt-8">
                ...
                <button
                  type="submit"
                  className="w-full md:w-auto bg-black text-white font-['Syne'] text-[20px] md:text-[24px] font-bold px-12 py-5 border-2 border-black transition-colors duration-300 hover:bg-transparent hover:text-black flex items-center justify-center gap-4 cursor-pointer"
                >
                  SEND BRIEF
